...
class KeyMetadataEntity:
    ...
    def delete(self, request: operations.DeleteKeyMetadataEntityRequest) -> operations.DeleteKeyMetadataEntityResponse:
    ...
    def get(self, request: operations.GetKeyMetadataEntityRequest) -> operations.GetKeyMetadataEntityResponse:
    ...
    def update(self, request: operations.UpdateKeyMetadataEntityRequest) -> operations.UpdateKeyMetadataEntityResponse:
