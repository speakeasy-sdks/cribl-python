...
class UIState:
    ...
    def get(self, key: str) -> operations.GetUIStateResponse:
        ...
        Get UI state by key
        """
        hook_ctx = HookContext(operation_id='getUIState', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        url = utils.generate_url(base_url, '/ui/{key}', request)
        ...
        res = operations.GetUIStateResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def update(self, key: str, ui_state_patch: Optional[components.UIStatePatch] = None) -> operations.UpdateUIStateResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='updateUIState', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        request = operations.UpdateUIStateRequest(
            key=key,
            ui_state_patch=ui_state_patch,
        )
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdateUIStateRequest, "ui_state_patch", False, True, 'json')
        ...
        res = operations.UpdateUIStateResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
