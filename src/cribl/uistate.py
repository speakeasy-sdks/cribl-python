...
class UIState:
    ...
    def get(self, key: str) -> operations.GetUIStateResponse:
        ...
        res = operations.GetUIStateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update(self, key: str, ui_state_patch: Optional[components.UIStatePatch] = None) -> operations.UpdateUIStateResponse:
        ...
        res = operations.UpdateUIStateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
