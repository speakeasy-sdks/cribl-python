...
class UIState:
    ...
    def get(self, request: operations.GetUIStateRequest) -> operations.GetUIStateResponse:
    ...
    def update(self, request: operations.UpdateUIStateRequest) -> operations.UpdateUIStateResponse:
