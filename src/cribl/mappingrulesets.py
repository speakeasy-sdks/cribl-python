...
class MappingRulesets:
    ...
    def delete(self, id: str) -> operations.DeleteMappingRulesetsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='deleteMappingRulesets', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.DeleteMappingRulesetsResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def get(self) -> operations.GetMappingRulesetsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getMappingRulesets', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.GetMappingRulesetsResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def update(self, id: str, mapping_ruleset: Optional[components.MappingRuleset] = None) -> operations.UpdateMappingRulesetsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='updateMappingRulesets', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdateMappingRulesetsRequest, "mapping_ruleset", False, True, 'json')
        ...
        res = operations.UpdateMappingRulesetsResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
