...
class MappingRulesets:
    ...
    def delete(self, request: operations.DeleteMappingRulesetsRequest) -> operations.DeleteMappingRulesetsResponse:
    ...
    def update(self, request: operations.UpdateMappingRulesetsRequest) -> operations.UpdateMappingRulesetsResponse:
