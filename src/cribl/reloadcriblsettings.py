...
class ReloadCriblSettings:
    ...
    def post(self) -> operations.PostReloadCriblSettingsResponse:
        ...
        hook_ctx = HookContext(operation_id='postReloadCriblSettings', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.PostReloadCriblSettingsResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
