...
class RegexLibEntryObject:
    ...
    def get(self) -> operations.GetRegexLibEntryObjectResponse:
        r"""Get a list of RegexLibEntry objects
        Get a list of RegexLibEntry objects
        """
        hook_ctx = HookContext(operation_id='getRegexLibEntryObject', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetRegexLibEntryObjectResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
