...
class OutputID:
    ...
    def delete(self, request: operations.DeleteOutputIDRequest) -> operations.DeleteOutputIDResponse:
        r"""Delete Output
        Delete Output
        """
    ...
    def get(self, request: operations.GetOutputIDRequest) -> operations.GetOutputIDResponse:
        r"""Get Output by ID
        Get Output by ID
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def update(self, request: operations.UpdateOutputIDRequest) -> operations.UpdateOutputIDResponse:
        r"""Update Output
        Update Output
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
