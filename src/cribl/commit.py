...
class Commit:
    ...
    def create(self, request: Optional[components.GitCommitParams]) -> operations.CreateCommitResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='createCommit', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = base_url + '/version/commit'
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, Optional[components.GitCommitParams], "request", False, True, 'json')
        ...
        res = operations.CreateCommitResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
