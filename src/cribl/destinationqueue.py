...
class DestinationQueue:
    ...
    def delete(self, id: str) -> operations.DeleteDestinationQueueResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='deleteDestinationQueue', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.DeleteDestinationQueueResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
