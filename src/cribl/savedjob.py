...
class SavedJob:
    ...
    def delete(self, request: operations.DeleteSavedJobRequest) -> operations.DeleteSavedJobResponse:
        r"""Delete SavedJob
        Delete SavedJob
        """
    ...
    def get(self, request: operations.GetSavedJobRequest) -> operations.GetSavedJobResponse:
    ...
    def update(self, request: operations.UpdateSavedJobRequest) -> operations.UpdateSavedJobResponse:
        r"""Update SavedJob
        Update SavedJob
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
