...
class LoggerConfig:
    ...
    def delete(self, request: operations.DeleteLoggerConfigRequest) -> operations.DeleteLoggerConfigResponse:
    ...
    def get(self, request: operations.GetLoggerConfigRequest) -> operations.GetLoggerConfigResponse:
    ...
    def update(self, request: operations.UpdateLoggerConfigRequest) -> operations.UpdateLoggerConfigResponse:
