...
class LoggerConfig:
    ...
    def delete(self, id: str) -> operations.DeleteLoggerConfigResponse:
        ...
        Delete LoggerConfig
        """
        hook_ctx = HookContext(operation_id='deleteLoggerConfig', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        url = utils.generate_url(base_url, '/system/logger/{id}', request)
        ...
        res = operations.DeleteLoggerConfigResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def get(self, id: str) -> operations.GetLoggerConfigResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getLoggerConfig', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetLoggerConfigResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def update(self, id: str, logger_config: Optional[components.LoggerConfig] = None) -> operations.UpdateLoggerConfigResponse:
        ...
        Update LoggerConfig
        """
        hook_ctx = HookContext(operation_id='updateLoggerConfig', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.UpdateLoggerConfigResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
