...
class Packs:
    ...
    def get(self) -> operations.GetPacksResponse:
        r"""Get info on packs
        Get info on packs
        """
        hook_ctx = HookContext(operation_id='getPacks', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetPacksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
