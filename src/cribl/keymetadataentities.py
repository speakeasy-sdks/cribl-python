...
class KeyMetadataEntities:
    ...
    def get(self) -> operations.GetKeyMetadataEntitiesResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getKeyMetadataEntities', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetKeyMetadataEntitiesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
