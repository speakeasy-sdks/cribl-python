...
class Groups:
    ...
    def get(self, fields_: Optional[str] = None, product: Optional[str] = None) -> operations.GetGroupsResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ConfigGroups])
