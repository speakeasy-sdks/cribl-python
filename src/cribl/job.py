...
class Job:
    ...
    def cancel(self, request: operations.CancelJobRequest) -> operations.CancelJobResponse:
    ...
    def delete(self, request: operations.DeleteJobRequest) -> operations.DeleteJobResponse:
    ...
    def get(self, request: operations.GetJobRequest) -> operations.GetJobResponse:
    ...
    def pause_job(self, request: operations.PauseJobRequest) -> operations.PauseJobResponse:
    ...
    def prevent(self, request: operations.PreventJobRequest) -> operations.PreventJobResponse:
    ...
    def resume(self, request: operations.ResumeJobRequest) -> operations.ResumeJobResponse:
