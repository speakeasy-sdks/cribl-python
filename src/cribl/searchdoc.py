...
class SearchDoc:
    ...
    def get(self) -> operations.GetSearchDocResponse:
        r"""Get Search documentation
        Get Search documentation
        """
        hook_ctx = HookContext(operation_id='getSearchDoc', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = base_url + '/search/docs'
        headers = {}
        ...
        res = operations.GetSearchDocResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
