...
class Certificate:
    ...
    def create(self, request: Optional[components.Certificate]) -> operations.CreateCertificateResponse:
        ...
        Create Certificate
        """
        hook_ctx = HookContext(operation_id='createCertificate', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.CreateCertificateResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def delete(self, id: str) -> operations.DeleteCertificateResponse:
        ...
        Delete Certificate
        """
        hook_ctx = HookContext(operation_id='deleteCertificate', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        url = utils.generate_url(base_url, '/system/certificates/{id}', request)
        ...
        res = operations.DeleteCertificateResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def get(self, id: str) -> operations.GetCertificateResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getCertificate', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetCertificateResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def update(self, id: str, certificate: Optional[components.Certificate] = None) -> operations.UpdateCertificateResponse:
        ...
        Update Certificate
        """
        hook_ctx = HookContext(operation_id='updateCertificate', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.UpdateCertificateResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
