...
class Certificate:
    ...
    def delete(self, request: operations.DeleteCertificateRequest) -> operations.DeleteCertificateResponse:
    ...
    def get(self, request: operations.GetCertificateRequest) -> operations.GetCertificateResponse:
    ...
    def update(self, request: operations.UpdateCertificateRequest) -> operations.UpdateCertificateResponse:
