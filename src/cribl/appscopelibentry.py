...
class AppscopeLibEntry:
    ...
    def delete(self, request: operations.DeleteAppscopeLibEntryRequest) -> operations.DeleteAppscopeLibEntryResponse:
    ...
    def get(self, request: operations.GetAppscopeLibEntryRequest) -> operations.GetAppscopeLibEntryResponse:
    ...
    def update(self, request: operations.UpdateAppscopeLibEntryRequest) -> operations.UpdateAppscopeLibEntryResponse:
