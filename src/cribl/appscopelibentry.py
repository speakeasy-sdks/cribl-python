...
class AppscopeLibEntry:
    ...
    def create(self, request: Optional[components.AppscopeLibEntry]) -> operations.CreateAppscopeLibEntryResponse:
        r"""Create AppscopeLibEntry
        Create AppscopeLibEntry
        """
        hook_ctx = HookContext(operation_id='createAppscopeLibEntry', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        
        url = base_url + '/lib/appscope-configs'
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, Optional[components.AppscopeLibEntry], "request", False, True, 'json')
        ...
        res = operations.CreateAppscopeLibEntryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete(self, id: str) -> operations.DeleteAppscopeLibEntryResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='deleteAppscopeLibEntry', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.DeleteAppscopeLibEntryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get(self, id: str) -> operations.GetAppscopeLibEntryResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getAppscopeLibEntry', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetAppscopeLibEntryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update(self, id: str, appscope_lib_entry: Optional[components.AppscopeLibEntry] = None) -> operations.UpdateAppscopeLibEntryResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='updateAppscopeLibEntry', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        request = operations.UpdateAppscopeLibEntryRequest(
            id=id,
            appscope_lib_entry=appscope_lib_entry,
        )
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdateAppscopeLibEntryRequest, "appscope_lib_entry", False, True, 'json')
        if req_content_type is not None and req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        ...
        res = operations.UpdateAppscopeLibEntryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
