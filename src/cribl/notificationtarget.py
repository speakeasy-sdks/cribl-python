...
class NotificationTarget:
    ...
    def create(self, request: Optional[Any]) -> operations.CreateNotificationTargetResponse:
    ...
    def update(self, id: str, request_body: Optional[Any] = None) -> operations.UpdatetNotificationTargetResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdatetNotificationTargetRequest, "request_body", False, True, 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
