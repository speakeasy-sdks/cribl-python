...
class RegexLibEntryID:
    ...
    def get(self, id: str) -> operations.GetRegexLibEntryIDResponse:
        r"""Get RegexLibEntry by ID
        Get RegexLibEntry by ID
        """
        hook_ctx = HookContext(operation_id='getRegexLibEntryID', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        url = utils.generate_url(operations.GetRegexLibEntryIDRequest, base_url, '/lib/regex/{id}', request)
        headers = {}
        ...
        res = operations.GetRegexLibEntryIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
