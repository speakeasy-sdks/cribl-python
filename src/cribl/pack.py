...
class Pack:
    ...
    def export(self, request: operations.ExportPackRequest) -> operations.ExportPackResponse:
        r"""Export Pack
        Export Pack
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def uninstall(self, request: operations.UninstallPackRequest) -> operations.UninstallPackResponse:
    ...
    def upgrade(self, request: operations.UpgradePackRequest) -> operations.UpgradePackResponse:
        r"""Upgrade Pack
        Upgrade Pack
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def upload(self, request: operations.UploadPackRequest) -> operations.UploadPackResponse:
        r"""Upload Pack
        Upload Pack
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
