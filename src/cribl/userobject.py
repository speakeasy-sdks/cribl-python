...
class UserObject:
    ...
    def get(self) -> operations.GetUserObjectResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getUserObject', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetUserObjectResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def update(self, id: str, user: Optional[components.User] = None) -> operations.UpdateUserObjectResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='updateUserObject', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        url = utils.generate_url(base_url, '/system/users/{id}/info', request)
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdateUserObjectRequest, "user", False, True, 'json')
        ...
        res = operations.UpdateUserObjectResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
