...
class OutputObjects:
    ...
    def get(self) -> operations.GetOutputObjectsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getOutputObjects', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetOutputObjectsResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
