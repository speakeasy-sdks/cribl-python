...
class FleetMappings:
    ...
    def get(self) -> operations.GetFleetMappingsResponse:
        r"""Get a list of MappingRuleset objects
        Get a list of MappingRuleset objects
        """
        hook_ctx = HookContext(operation_id='getFleetMappings', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetFleetMappingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
