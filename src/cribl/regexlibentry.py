...
class RegexLibEntry:
    ...
    def delete(self, request: operations.DeleteRegexLibEntryRequest) -> operations.DeleteRegexLibEntryResponse:
    ...
    def update(self, request: operations.UpdateRegexLibEntryRequest) -> operations.UpdateRegexLibEntryResponse:
