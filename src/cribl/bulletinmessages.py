...
class BulletinMessages:
    ...
    def get(self) -> operations.GetBulletinMessagesResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getBulletinMessages', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetBulletinMessagesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
