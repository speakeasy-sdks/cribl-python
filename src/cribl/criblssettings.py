...
class CriblsSettings:
    ...
    def get(self) -> operations.GetCriblsSettingsResponse:
        ...
        res = operations.GetCriblsSettingsResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def update(self) -> operations.UpdateCriblsSettingsResponse:
        ...
        res = operations.UpdateCriblsSettingsResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
