...
class OutputInfluxdb:
    ...
    TYPE: Final[str] = dataclasses.field(default='influxdb', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    ...
    auth_type: Optional[OutputInfluxdbAuthenticationType] = dataclasses.field(default=OutputInfluxdbAuthenticationType.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""InfluxDB authentication type"""
    ...
    dynamic_value_field_name: Optional[bool] = dataclasses.field(default=True, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dynamicValueFieldName'), 'exclude': lambda f: f is None }})
    ...
    failed_request_logging_mode: Optional[OutputInfluxdbFailedRequestLoggingMode] = dataclasses.field(default=OutputInfluxdbFailedRequestLoggingMode.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedRequestLoggingMode'), 'exclude': lambda f: f is None }})
    r"""Determines which data should be logged when a request fails. Defaults to None.  All headers are redacted by default, except those listed under `Safe Headers`."""
    ...
    on_backpressure: Optional[OutputInfluxdbBackpressureBehavior] = dataclasses.field(default=OutputInfluxdbBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    OPTIONAL_FIELDS_IN_GENERAL_SECTION: Final[Optional[str]] = dataclasses.field(default='useV2API', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('optionalFieldsInGeneralSection'), 'exclude': lambda f: f is None }})
    ...
    pq_compress: Optional[OutputInfluxdbCompression] = dataclasses.field(default=OutputInfluxdbCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputInfluxdbQueueFullBehavior] = dataclasses.field(default=OutputInfluxdbQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    timestamp_precision: Optional[OutputInfluxdbTimestampPrecision] = dataclasses.field(default=OutputInfluxdbTimestampPrecision.MS, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('timestampPrecision'), 'exclude': lambda f: f is None }})
    r"""Sets the precision for the supplied Unix time values. Defaults to milliseconds."""
    ...
    use_v2_api: Optional[bool] = dataclasses.field(default=False, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('useV2API'), 'exclude': lambda f: f is None }})
    r"""The v2 API can be enabled with InfluxDB versions 1.8 and later."""
    value_field_name: Optional[str] = dataclasses.field(default='value', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('valueFieldName'), 'exclude': lambda f: f is None }})
