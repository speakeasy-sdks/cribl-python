...
class OutputAzureEventhubAuthentication:
    ...
    mechanism: Optional[OutputAzureEventhubAuthenticationSASLMechanism] = dataclasses.field(default=OutputAzureEventhubAuthenticationSASLMechanism.PLAIN, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mechanism'), 'exclude': lambda f: f is None }})
    r"""SASL authentication mechanism to use"""
...
class OutputAzureEventhub:
    ...
    ack: Optional[OutputAzureEventhubAcknowledgments] = dataclasses.field(default=OutputAzureEventhubAcknowledgments.ONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ack'), 'exclude': lambda f: f is None }})
    r"""Control the number of required acknowledgments"""
    ...
    format: Optional[OutputAzureEventhubRecordDataFormat] = dataclasses.field(default=OutputAzureEventhubRecordDataFormat.JSON, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format'), 'exclude': lambda f: f is None }})
    r"""Format to use to serialize events before writing to the Event Hubs Kafka brokers."""
    ...
    pq_compress: Optional[OutputAzureEventhubCompression] = dataclasses.field(default=OutputAzureEventhubCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputAzureEventhubQueueFullBehavior] = dataclasses.field(default=OutputAzureEventhubQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='azure_eventhub', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
