...
class OutputGoogleCloudLogging:
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='google_cloud_logging', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
