...
class OutputCriblTCPHosts:
    ...
    tls: Optional[OutputCriblTCPHostsTLS] = dataclasses.field(default=OutputCriblTCPHostsTLS.INHERIT, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tls'), 'exclude': lambda f: f is None }})
    r"""Whether to inherit TLS configs from group setting or disable TLS."""
...
class OutputCriblTCP:
    ...
    TYPE: Final[str] = dataclasses.field(default='cribl_tcp', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    ...
    port: Optional[int] = dataclasses.field(default=10300, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('port'), 'exclude': lambda f: f is None }})
    r"""The port to connect to on the provided host"""
    pq_compress: Optional[OutputCriblTCPCompression] = dataclasses.field(default=OutputCriblTCPCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
