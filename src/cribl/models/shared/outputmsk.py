...
class OutputMsk:
    ...
    pq_compress: Optional[OutputMskCompression1] = dataclasses.field(default=OutputMskCompression1.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='msk', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
