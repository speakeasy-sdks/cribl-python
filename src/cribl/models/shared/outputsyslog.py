...
class OutputSyslog:
    ...
    TYPE: Final[str] = dataclasses.field(default='syslog', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    ...
    facility: Optional[OutputSyslogFacility] = dataclasses.field(default=OutputSyslogFacility.ONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('facility'), 'exclude': lambda f: f is None }})
    r"""Default value for message facility, will be overwritten by value of __facility if set. Defaults to user."""
    ...
    PROTOCOL: Final[Optional[str]] = dataclasses.field(default='udp', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    ...
    timestamp_format: Optional[OutputSyslogTimestampFormat] = dataclasses.field(default=OutputSyslogTimestampFormat.SYSLOG, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('timestampFormat'), 'exclude': lambda f: f is None }})
    r"""Timestamp format to use when serializing event's time field"""
