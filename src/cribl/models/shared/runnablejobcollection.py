...
class RunnableJobCollectionInput:
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='collection', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
...
class RunnableJobCollectionRun:
    ...
    MODE: Final[Optional[str]] = dataclasses.field(default='run', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mode'), 'exclude': lambda f: f is None }})
