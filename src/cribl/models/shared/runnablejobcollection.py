...
class RunnableJobCollectionInput:
    ...
    type: Optional[RunnableJobCollectionInputType] = dataclasses.field(default=RunnableJobCollectionInputType.COLLECTION, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
...
class RunnableJobCollectionRunCaptureSettings:
    level: Optional[RunnableJobCollectionRunCaptureSettingsWhereToCapture] = dataclasses.field(default=RunnableJobCollectionRunCaptureSettingsWhereToCapture.ZERO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('level'), 'exclude': lambda f: f is None }})
...
class RunnableJobCollectionRun:
    ...
    log_level: Optional[RunnableJobCollectionRunLogLevel] = dataclasses.field(default=RunnableJobCollectionRunLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
    ...
    mode: Optional[RunnableJobCollectionRunMode] = dataclasses.field(default=RunnableJobCollectionRunMode.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mode'), 'exclude': lambda f: f is None }})
    r"""Job run mode. Preview will either return up to N matching results, or will run until capture time T is reached. Discovery will gather the list of files to turn into streaming tasks, without running the data collection job. Full Run will run the collection job."""
...
class RunnableJobCollectionScheduleRunSettings:
    ...
    latest: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('latest'), 'exclude': lambda f: f is None }})
    r"""Latest time, for the given Range Timezone."""
    log_level: Optional[RunnableJobCollectionScheduleRunSettingsLogLevel] = dataclasses.field(default=RunnableJobCollectionScheduleRunSettingsLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
    max_task_reschedule: Optional[int] = dataclasses.field(default=1, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxTaskReschedule'), 'exclude': lambda f: f is None }})
    r"""Max number of times a task can be rescheduled."""
    max_task_size: Optional[str] = dataclasses.field(default='10MB', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxTaskSize'), 'exclude': lambda f: f is None }})
