...
class OutputAzureLogs:
    TYPE: Final[str] = dataclasses.field(default='azure_logs', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    api_url: Optional[str] = dataclasses.field(default='.ods.opinsights.azure.com', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('apiUrl'), 'exclude': lambda f: f is None }})
    ...
    auth_type: Optional[OutputAzureLogsAuthenticationMethod] = dataclasses.field(default=OutputAzureLogsAuthenticationMethod.MANUAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""Enter workspace ID and workspace key directly, or select a stored secret"""
    ...
    failed_request_logging_mode: Optional[OutputAzureLogsFailedRequestLoggingMode] = dataclasses.field(default=OutputAzureLogsFailedRequestLoggingMode.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedRequestLoggingMode'), 'exclude': lambda f: f is None }})
    r"""Determines which data should be logged when a request fails. Defaults to None.  All headers are redacted by default, except those listed under `Safe Headers`."""
    ...
    log_type: Optional[str] = dataclasses.field(default='Cribl', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logType'), 'exclude': lambda f: f is None }})
    ...
    on_backpressure: Optional[OutputAzureLogsBackpressureBehavior] = dataclasses.field(default=OutputAzureLogsBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputAzureLogsCompression] = dataclasses.field(default=OutputAzureLogsCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputAzureLogsQueueFullBehavior] = dataclasses.field(default=OutputAzureLogsQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
