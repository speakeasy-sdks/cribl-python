...
class RunnableJobExecutorExecutorExecutorSpecificSettings:
    pass
...
@dataclasses.dataclass
class RunnableJobExecutorExecutor:
    type: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of executor to run."""
    conf: Optional[RunnableJobExecutorExecutorExecutorSpecificSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conf'), 'exclude': lambda f: f is None }})
    store_task_results: Optional[bool] = dataclasses.field(default=True, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('storeTaskResults'), 'exclude': lambda f: f is None }})
    r"""Determines whether or not to write task results to disk."""
    


class RunnableJobExecutorRunLogLevel(str, Enum):
...
class RunnableJobExecutorRun:
    ...
    log_level: Optional[RunnableJobExecutorRunLogLevel] = dataclasses.field(default=RunnableJobExecutorRunLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
...
class RunnableJobExecutorScheduleRunSettingsLogLevel(str, Enum):
    r"""Level at which to set task logging."""
    ERROR = 'error'
    WARN = 'warn'
    INFO = 'info'
...
@dataclasses.dataclass
class RunnableJobExecutorScheduleRunSettings:
    ...
    log_level: Optional[RunnableJobExecutorScheduleRunSettingsLogLevel] = dataclasses.field(default=RunnableJobExecutorScheduleRunSettingsLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
    max_task_reschedule: Optional[int] = dataclasses.field(default=1, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxTaskReschedule'), 'exclude': lambda f: f is None }})
    r"""Max number of times a task can be rescheduled."""
...
@dataclasses.dataclass
class RunnableJobExecutorSchedule:
    ...
    run: Optional[RunnableJobExecutorScheduleRunSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('run'), 'exclude': lambda f: f is None }})
...
@dataclasses.dataclass
class RunnableJobExecutor:
    executor: RunnableJobExecutorExecutor = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('executor') }})
    run: RunnableJobExecutorRun = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('run') }})
    ...
    schedule: Optional[RunnableJobExecutorSchedule] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('schedule'), 'exclude': lambda f: f is None }})
    r"""Configuration for a scheduled job."""
    ...
    type: Optional[RunnableJobExecutorJobType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Job type."""
