...
class OutputPrometheus:
    ...
    TYPE: Final[str] = dataclasses.field(default='prometheus', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    ...
    auth_type: Optional[OutputPrometheusAuthenticationType] = dataclasses.field(default=OutputPrometheusAuthenticationType.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""Remote Write authentication type"""
    ...
    failed_request_logging_mode: Optional[OutputPrometheusFailedRequestLoggingMode] = dataclasses.field(default=OutputPrometheusFailedRequestLoggingMode.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedRequestLoggingMode'), 'exclude': lambda f: f is None }})
    r"""Determines which data should be logged when a request fails. Defaults to None.  All headers are redacted by default, except those listed under `Safe Headers`."""
    ...
    metrics_flush_period_sec: Optional[int] = dataclasses.field(default=60, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metricsFlushPeriodSec'), 'exclude': lambda f: f is None }})
    ...
    on_backpressure: Optional[OutputPrometheusBackpressureBehavior] = dataclasses.field(default=OutputPrometheusBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputPrometheusCompression] = dataclasses.field(default=OutputPrometheusCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputPrometheusQueueFullBehavior] = dataclasses.field(default=OutputPrometheusQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    send_metadata: Optional[bool] = dataclasses.field(default=True, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sendMetadata'), 'exclude': lambda f: f is None }})
