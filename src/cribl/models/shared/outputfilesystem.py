...
class OutputFilesystem:
    ...
    TYPE: Final[str] = dataclasses.field(default='filesystem', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    ...
    compress: Optional[OutputFilesystemCompress] = dataclasses.field(default=OutputFilesystemCompress.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('compress'), 'exclude': lambda f: f is None }})
    r"""Choose data compression format to apply before moving files to final destination."""
    ...
    format: Optional[OutputFilesystemDataFormat] = dataclasses.field(default=OutputFilesystemDataFormat.JSON, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format'), 'exclude': lambda f: f is None }})
    r"""Format of the output data."""
    ...
    on_backpressure: Optional[OutputFilesystemBackpressureBehavior] = dataclasses.field(default=OutputFilesystemBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when all receivers are exerting backpressure."""
    parquet_data_page_version: Optional[OutputFilesystemDataPageVersion] = dataclasses.field(default=OutputFilesystemDataPageVersion.DATA_PAGE_V1, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parquetDataPageVersion'), 'exclude': lambda f: f is None }})
    r"""Serialization format of data pages. Note that not all reader implentations support Data page V2."""
    ...
    parquet_version: Optional[OutputFilesystemParquetVersion] = dataclasses.field(default=OutputFilesystemParquetVersion.PARQUET_2_6, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parquetVersion'), 'exclude': lambda f: f is None }})
    r"""Determines which data types are supported and how they are represented."""
