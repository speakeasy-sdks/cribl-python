...
class NotificationTargetWebhook:
    ...
    TYPE: Final[str] = dataclasses.field(default='webhook', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    auth_type: Optional[NotificationTargetWebhookAuthenticationType] = dataclasses.field(default=NotificationTargetWebhookAuthenticationType.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""The authentication method to use for the HTTP request. Defaults to None."""
    ...
    failed_request_logging_mode: Optional[NotificationTargetWebhookFailedRequestLoggingMode] = dataclasses.field(default=NotificationTargetWebhookFailedRequestLoggingMode.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedRequestLoggingMode'), 'exclude': lambda f: f is None }})
    r"""Determines which data should be logged when a request fails. Defaults to None.  All headers are redacted by default, except those listed under `Safe Headers`."""
    ...
    format: Optional[NotificationTargetWebhookFormat] = dataclasses.field(default=NotificationTargetWebhookFormat.JSON_ARRAY, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format'), 'exclude': lambda f: f is None }})
    r"""Specifies how to format events before sending out. Defaults to NDJSON."""
    ...
    method: Optional[NotificationTargetWebhookMethod] = dataclasses.field(default=NotificationTargetWebhookMethod.POST, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('method'), 'exclude': lambda f: f is None }})
    r"""The method to use when sending events. Defaults to POST."""
