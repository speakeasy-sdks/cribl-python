...
class OutputElasticAuth:
    auth_type: Optional[OutputElasticAuthAuthenticationMethod] = dataclasses.field(default=OutputElasticAuthAuthenticationMethod.MANUAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""Enter credentials directly, or select a stored secret"""
...
class OutputElastic:
    ...
    TYPE: Final[str] = dataclasses.field(default='elastic', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    ...
    elastic_version: Optional[OutputElasticElasticVersion] = dataclasses.field(default=OutputElasticElasticVersion.AUTO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('elasticVersion'), 'exclude': lambda f: f is None }})
    r"""Optional Elasticsearch version, used to format events. If not specified, will auto-discover version."""
