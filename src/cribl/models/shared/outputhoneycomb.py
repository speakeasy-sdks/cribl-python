...
class OutputHoneycomb:
    ...
    TYPE: Final[str] = dataclasses.field(default='honeycomb', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    auth_type: Optional[OutputHoneycombAuthenticationMethod] = dataclasses.field(default=OutputHoneycombAuthenticationMethod.MANUAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""Enter API key directly, or select a stored secret"""
    ...
    failed_request_logging_mode: Optional[OutputHoneycombFailedRequestLoggingMode] = dataclasses.field(default=OutputHoneycombFailedRequestLoggingMode.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedRequestLoggingMode'), 'exclude': lambda f: f is None }})
    r"""Determines which data should be logged when a request fails. Defaults to None.  All headers are redacted by default, except those listed under `Safe Headers`."""
    ...
    on_backpressure: Optional[OutputHoneycombBackpressureBehavior] = dataclasses.field(default=OutputHoneycombBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputHoneycombCompression] = dataclasses.field(default=OutputHoneycombCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputHoneycombQueueFullBehavior] = dataclasses.field(default=OutputHoneycombQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
