...
class OutputNewrelicExtraHTTPHeaders:
...
class OutputNewrelicMetadataName(str, Enum):
    r"""Field name"""
    SERVICE = 'service'
    HOSTNAME = 'hostname'
    TIMESTAMP = 'timestamp'
...
@dataclasses.dataclass
class OutputNewrelicMetadata:
    name: OutputNewrelicMetadataName = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    r"""Field name"""
    value: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})
...
@dataclasses.dataclass
class OutputNewrelicPqControls:
    pass
...
@dataclasses.dataclass
class OutputNewrelic:
    TYPE: Final[str] = dataclasses.field(default='newrelic', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    ...
    auth_type: Optional[OutputNewrelicAuthenticationMethod] = dataclasses.field(default=OutputNewrelicAuthenticationMethod.MANUAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""Enter API key directly, or select a stored secret"""
    ...
    extra_http_headers: Optional[list[OutputNewrelicExtraHTTPHeaders]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('extraHttpHeaders'), 'exclude': lambda f: f is None }})
    r"""Headers to add to all events."""
    failed_request_logging_mode: Optional[OutputNewrelicFailedRequestLoggingMode] = dataclasses.field(default=OutputNewrelicFailedRequestLoggingMode.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedRequestLoggingMode'), 'exclude': lambda f: f is None }})
    r"""Determines which data should be logged when a request fails. Defaults to None.  All headers are redacted by default, except those listed under `Safe Headers`."""
    ...
    log_type: Optional[str] = dataclasses.field(default='', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logType'), 'exclude': lambda f: f is None }})
    ...
    message_field: Optional[str] = dataclasses.field(default='', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('messageField'), 'exclude': lambda f: f is None }})
    r"""Name of field to send as log message value. If not present, event will be serialized and sent as JSON."""
    metadata: Optional[list[OutputNewrelicMetadata]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metadata'), 'exclude': lambda f: f is None }})
    r"""Fields to add to events from this input."""
    on_backpressure: Optional[OutputNewrelicBackpressureBehavior] = dataclasses.field(default=OutputNewrelicBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputNewrelicCompression] = dataclasses.field(default=OutputNewrelicCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    pq_controls: Optional[OutputNewrelicPqControls] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqControls'), 'exclude': lambda f: f is None }})
    ...
    pq_on_backpressure: Optional[OutputNewrelicQueueFullBehavior] = dataclasses.field(default=OutputNewrelicQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    region: Optional[OutputNewrelicRegion] = dataclasses.field(default=OutputNewrelicRegion.US, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('region'), 'exclude': lambda f: f is None }})
    r"""Which New Relic region endpoint to use."""
