...
class OutputSns:
    ...
    r"""Access key"""
    aws_authentication_method: Optional[OutputSnsAuthenticationMethod] = dataclasses.field(default=OutputSnsAuthenticationMethod.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('awsAuthenticationMethod'), 'exclude': lambda f: f is None }})
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    on_backpressure: Optional[OutputSnsBackpressureBehavior] = dataclasses.field(default=OutputSnsBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputSnsCompression] = dataclasses.field(default=OutputSnsCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputSnsQueueFullBehavior] = dataclasses.field(default=OutputSnsQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    signature_version: Optional[OutputSnsSignatureVersion] = dataclasses.field(default=OutputSnsSignatureVersion.V4, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('signatureVersion'), 'exclude': lambda f: f is None }})
    r"""Signature version to use for signing SNS requests."""
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='sns', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
