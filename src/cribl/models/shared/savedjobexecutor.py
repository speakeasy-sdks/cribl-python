...
class SavedJobExecutorScheduleRunSettings:
    ...
    log_level: Optional[SavedJobExecutorScheduleRunSettingsLogLevel] = dataclasses.field(default=SavedJobExecutorScheduleRunSettingsLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
