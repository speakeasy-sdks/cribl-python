...
class RunnableJobScheduledSearchScheduleRunSettings:
    ...
    log_level: Optional[RunnableJobScheduledSearchScheduleRunSettingsLogLevel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
