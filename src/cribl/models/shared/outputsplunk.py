...
class OutputSplunk:
    ...
    max_s2_sversion: Optional[OutputSplunkMaxS2SVersion] = dataclasses.field(default=OutputSplunkMaxS2SVersion.V3, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxS2Sversion'), 'exclude': lambda f: f is None }})
    r"""The highest S2S protocol version to advertise during handshake."""
    nested_fields: Optional[OutputSplunkNestedFieldSerialization] = dataclasses.field(default=OutputSplunkNestedFieldSerialization.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('nestedFields'), 'exclude': lambda f: f is None }})
    r"""Specifies how to serialize nested fields into index-time fields."""
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='splunk', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
