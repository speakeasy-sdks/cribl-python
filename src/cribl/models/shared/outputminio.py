...
class OutputMinio:
    ...
    aws_authentication_method: Optional[OutputMinioAuthenticationMethod] = dataclasses.field(default=OutputMinioAuthenticationMethod.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('awsAuthenticationMethod'), 'exclude': lambda f: f is None }})
    r"""AWS authentication method"""
