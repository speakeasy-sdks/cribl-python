...
class OutputMinio:
    ...
    AWS_AUTHENTICATION_METHOD: Final[Optional[str]] = dataclasses.field(default='secret', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('awsAuthenticationMethod'), 'exclude': lambda f: f is None }})
    ...
    compress: Optional[OutputMinioCompress] = dataclasses.field(default=OutputMinioCompress.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('compress'), 'exclude': lambda f: f is None }})
    r"""Choose data compression format to apply before moving files to final destination."""
    ...
    format: Optional[OutputMinioDataFormat] = dataclasses.field(default=OutputMinioDataFormat.JSON, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format'), 'exclude': lambda f: f is None }})
    r"""Format of the output data."""
    ...
    object_acl: Optional[OutputMinioObjectACL] = dataclasses.field(default=OutputMinioObjectACL.PRIVATE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('objectACL'), 'exclude': lambda f: f is None }})
    r"""Object ACL to assign to uploaded objects."""
    on_backpressure: Optional[OutputMinioBackpressureBehavior] = dataclasses.field(default=OutputMinioBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when all receivers are exerting backpressure."""
    parquet_data_page_version: Optional[OutputMinioDataPageVersion] = dataclasses.field(default=OutputMinioDataPageVersion.DATA_PAGE_V1, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parquetDataPageVersion'), 'exclude': lambda f: f is None }})
    r"""Serialization format of data pages. Note that not all reader implentations support Data page V2."""
    ...
    parquet_version: Optional[OutputMinioParquetVersion] = dataclasses.field(default=OutputMinioParquetVersion.PARQUET_2_6, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parquetVersion'), 'exclude': lambda f: f is None }})
    r"""Determines which data types are supported and how they are represented."""
    ...
    SERVER_SIDE_ENCRYPTION: Final[Optional[str]] = dataclasses.field(default='AES256', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('serverSideEncryption'), 'exclude': lambda f: f is None }})
    ...
    signature_version: Optional[OutputMinioSignatureVersion] = dataclasses.field(default=OutputMinioSignatureVersion.V4, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('signatureVersion'), 'exclude': lambda f: f is None }})
    r"""Signature version to use for signing MinIO requests."""
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='minio', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
