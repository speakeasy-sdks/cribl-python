...
class OutputCloudwatchPqControls:
    pass
...
class OutputCloudwatchRegion(str, Enum):
...
class OutputCloudwatchSignatureVersion(str, Enum):
    r"""Signature version to use for signing CloudWatchLogs requests."""
    V2 = 'v2'
    V4 = 'v4'
...
class OutputCloudwatch:
    ...
    region: OutputCloudwatchRegion = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('region') }})
    r"""Region where the CloudWatchLogs is located"""
    ...
    r"""Access key"""
    aws_authentication_method: Optional[OutputCloudwatchAuthenticationMethod] = dataclasses.field(default=OutputCloudwatchAuthenticationMethod.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('awsAuthenticationMethod'), 'exclude': lambda f: f is None }})
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    max_queue_size: Optional[int] = dataclasses.field(default=5, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxQueueSize'), 'exclude': lambda f: f is None }})
    r"""Maximum number of queued batches before blocking"""
    max_record_size_kb: Optional[int] = dataclasses.field(default=1024, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxRecordSizeKB'), 'exclude': lambda f: f is None }})
    r"""Maximum size (KB) of each individual record before compression. For non compressible data 1MB is the max recommended size"""
    on_backpressure: Optional[OutputCloudwatchBackpressureBehavior] = dataclasses.field(default=OutputCloudwatchBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputCloudwatchCompression] = dataclasses.field(default=OutputCloudwatchCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    pq_controls: Optional[OutputCloudwatchPqControls] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqControls'), 'exclude': lambda f: f is None }})
    ...
    pq_on_backpressure: Optional[OutputCloudwatchQueueFullBehavior] = dataclasses.field(default=OutputCloudwatchQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    signature_version: Optional[OutputCloudwatchSignatureVersion] = dataclasses.field(default=OutputCloudwatchSignatureVersion.V4, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('signatureVersion'), 'exclude': lambda f: f is None }})
    r"""Signature version to use for signing CloudWatchLogs requests."""
    ...
    type: Optional[OutputCloudwatchType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
