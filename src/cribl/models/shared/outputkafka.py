...
class OutputKafkaAuthentication:
    ...
    mechanism: Optional[OutputKafkaAuthenticationSASLMechanism] = dataclasses.field(default=OutputKafkaAuthenticationSASLMechanism.PLAIN, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mechanism'), 'exclude': lambda f: f is None }})
    r"""SASL authentication mechanism to use."""
...
class OutputKafka:
    ...
    pq_compress: Optional[OutputKafkaCompression1] = dataclasses.field(default=OutputKafkaCompression1.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='kafka', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
