...
class OutputCriblHTTPExtraHTTPHeaders:
...
class OutputCriblHTTPOptionalFieldsInGeneralSection(str, Enum):
...
@dataclasses.dataclass
class OutputCriblHTTPPqControls:
    pass
...
class OutputCriblHTTPTLSSettingsClientSideMaximumTLSVersion(str, Enum):
...
class OutputCriblHTTPTLSSettingsClientSideMinimumTLSVersion(str, Enum):
...
@dataclasses.dataclass
class OutputCriblHTTPTLSSettingsClientSide:
    ...
    max_version: Optional[OutputCriblHTTPTLSSettingsClientSideMaximumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxVersion'), 'exclude': lambda f: f is None }})
    r"""Maximum TLS version to use when connecting"""
    min_version: Optional[OutputCriblHTTPTLSSettingsClientSideMinimumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('minVersion'), 'exclude': lambda f: f is None }})
    r"""Minimum TLS version to use when connecting"""
...
@dataclasses.dataclass
class OutputCriblHTTPUrls:
    url: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('url') }})
    r"""URL of a Cribl Worker to send events to, e.g., http://localhost:10200"""
...
@dataclasses.dataclass
class OutputCriblHTTP:
    id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id') }})
    r"""Unique ID for this output"""
    TYPE: Final[str] = dataclasses.field(default='cribl_http', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    compression: Optional[OutputCriblHTTPCompression] = dataclasses.field(default=OutputCriblHTTPCompression.GZIP, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('compression'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the data before sending."""
    ...
    extra_http_headers: Optional[list[OutputCriblHTTPExtraHTTPHeaders]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('extraHttpHeaders'), 'exclude': lambda f: f is None }})
    r"""Headers to add to all events."""
    failed_request_logging_mode: Optional[OutputCriblHTTPFailedRequestLoggingMode] = dataclasses.field(default=OutputCriblHTTPFailedRequestLoggingMode.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedRequestLoggingMode'), 'exclude': lambda f: f is None }})
    r"""Determines which data should be logged when a request fails. Defaults to None.  All headers are redacted by default, except those listed under `Safe Headers`."""
    ...
    on_backpressure: Optional[OutputCriblHTTPBackpressureBehavior] = dataclasses.field(default=OutputCriblHTTPBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    optional_fields_in_general_section: Optional[OutputCriblHTTPOptionalFieldsInGeneralSection] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('optionalFieldsInGeneralSection'), 'exclude': lambda f: f is None }})
    ...
    pq_compress: Optional[OutputCriblHTTPCompression] = dataclasses.field(default=OutputCriblHTTPCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    pq_controls: Optional[OutputCriblHTTPPqControls] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqControls'), 'exclude': lambda f: f is None }})
    ...
    pq_on_backpressure: Optional[OutputCriblHTTPQueueFullBehavior] = dataclasses.field(default=OutputCriblHTTPQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    tls: Optional[OutputCriblHTTPTLSSettingsClientSide] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tls'), 'exclude': lambda f: f is None }})
    ...
    r"""URL of a Cribl Worker to send events to, e.g., http://localhost:10200"""
    urls: Optional[list[OutputCriblHTTPUrls]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('urls'), 'exclude': lambda f: f is None }})
