...
class OutputOpenTelemetry:
    ...
    TYPE: Final[str] = dataclasses.field(default='open_telemetry', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    ...
    http_compress: Optional[OutputOpenTelemetryCompression1] = dataclasses.field(default=OutputOpenTelemetryCompression1.GZIP, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('httpCompress'), 'exclude': lambda f: f is None }})
    r"""Type of compression to apply to messages sent to the OpenTelemetry endpoint"""
    ...
    pq_compress: Optional[OutputOpenTelemetryCompression1] = dataclasses.field(default=OutputOpenTelemetryCompression1.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
