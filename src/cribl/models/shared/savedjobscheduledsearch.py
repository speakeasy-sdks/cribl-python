...
class SavedJobScheduledSearchScheduleRunSettingsLogLevel(str, Enum):
...
class SavedJobScheduledSearchScheduleRunSettings:
    ...
    log_level: Optional[SavedJobScheduledSearchScheduleRunSettingsLogLevel] = dataclasses.field(default=SavedJobScheduledSearchScheduleRunSettingsLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
...
@dataclasses.dataclass
class SavedJobScheduledSearchSchedule:
    ...
    run: Optional[SavedJobScheduledSearchScheduleRunSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('run'), 'exclude': lambda f: f is None }})
...
class SavedJobScheduledSearchJobType(str, Enum):
    r"""Job type."""
...
class SavedJobScheduledSearch:
    ...
    type: SavedJobScheduledSearchJobType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Job type."""
    ...
    schedule: Optional[SavedJobScheduledSearchSchedule] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('schedule'), 'exclude': lambda f: f is None }})
    r"""Configuration for a scheduled job."""
