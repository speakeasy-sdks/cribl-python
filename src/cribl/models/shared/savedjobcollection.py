...
class SavedJobCollectionInput:
    ...
    type: Optional[SavedJobCollectionInputType] = dataclasses.field(default=SavedJobCollectionInputType.COLLECTION, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
...
class SavedJobCollectionScheduleRunSettings:
    ...
    log_level: Optional[SavedJobCollectionScheduleRunSettingsLogLevel] = dataclasses.field(default=SavedJobCollectionScheduleRunSettingsLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
