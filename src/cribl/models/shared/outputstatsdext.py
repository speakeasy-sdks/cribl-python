...
class OutputStatsdExt:
    ...
    PROTOCOL: Final[Optional[str]] = dataclasses.field(default='tcp', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    ...
    TYPE: Final[Optional[str]] = dataclasses.field(default='statsd_ext', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
