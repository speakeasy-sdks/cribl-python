...
class OutputStatsdExtPqControls:
    pass
...
class OutputStatsdExt:
    ...
    mtu: Optional[int] = dataclasses.field(default=512, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mtu'), 'exclude': lambda f: f is None }})
    ...
    on_backpressure: Optional[OutputStatsdExtBackpressureBehavior] = dataclasses.field(default=OutputStatsdExtBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    port: Optional[int] = dataclasses.field(default=8125, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('port'), 'exclude': lambda f: f is None }})
    r"""Destination port."""
    pq_compress: Optional[OutputStatsdExtCompression] = dataclasses.field(default=OutputStatsdExtCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    pq_controls: Optional[OutputStatsdExtPqControls] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqControls'), 'exclude': lambda f: f is None }})
    ...
    pq_on_backpressure: Optional[OutputStatsdExtQueueFullBehavior] = dataclasses.field(default=OutputStatsdExtQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    protocol: Optional[OutputStatsdExtDestinationProtocol] = dataclasses.field(default=OutputStatsdExtDestinationProtocol.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    r"""Protocol to use when communicating with the destination."""
    ...
    type: Optional[OutputStatsdExtType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
