...
class OutputSignalfx:
    TYPE: Final[str] = dataclasses.field(default='signalfx', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    auth_type: Optional[OutputSignalfxAuthenticationMethod] = dataclasses.field(default=OutputSignalfxAuthenticationMethod.MANUAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""Enter a token directly, or provide a secret referencing a token"""
    ...
    failed_request_logging_mode: Optional[OutputSignalfxFailedRequestLoggingMode] = dataclasses.field(default=OutputSignalfxFailedRequestLoggingMode.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedRequestLoggingMode'), 'exclude': lambda f: f is None }})
    r"""Determines which data should be logged when a request fails. Defaults to None.  All headers are redacted by default, except those listed under `Safe Headers`."""
    ...
    on_backpressure: Optional[OutputSignalfxBackpressureBehavior] = dataclasses.field(default=OutputSignalfxBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputSignalfxCompression] = dataclasses.field(default=OutputSignalfxCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputSignalfxQueueFullBehavior] = dataclasses.field(default=OutputSignalfxQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    realm: Optional[str] = dataclasses.field(default='us0', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('realm'), 'exclude': lambda f: f is None }})
