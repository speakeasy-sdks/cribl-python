...
class MaxS2SVersion(str, Enum):
    r"""The highest S2S protocol version to advertise during handshake."""
    V3 = 'v3'
    V4 = 'v4'

class NestedFieldSerialization(str, Enum):
...
class OutputSplunkTLSSettingsClientSide:
    ...
    max_version: Optional[OutputSplunkMaximumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxVersion'), 'exclude': lambda f: f is None }})
    r"""Maximum TLS version to use when connecting"""
    min_version: Optional[OutputSplunkMinimumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('minVersion'), 'exclude': lambda f: f is None }})
    r"""Minimum TLS version to use when connecting"""
...
class OutputSplunk:
    ...
    auth_type: Optional[OutputSplunkAuthenticationMethod] = dataclasses.field(default=OutputSplunkAuthenticationMethod.MANUAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""Enter a token directly, or provide a secret referencing a token"""
    ...
    max_s2_sversion: Optional[MaxS2SVersion] = dataclasses.field(default=MaxS2SVersion.V3, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxS2Sversion'), 'exclude': lambda f: f is None }})
    r"""The highest S2S protocol version to advertise during handshake."""
    nested_fields: Optional[NestedFieldSerialization] = dataclasses.field(default=NestedFieldSerialization.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('nestedFields'), 'exclude': lambda f: f is None }})
    r"""Specifies how to serialize nested fields into index-time fields."""
    on_backpressure: Optional[OutputSplunkBackpressureBehavior] = dataclasses.field(default=OutputSplunkBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputSplunkCompression] = dataclasses.field(default=OutputSplunkCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputSplunkQueueFullBehavior] = dataclasses.field(default=OutputSplunkQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
