...
class GetNamesOpts:
    ...
    filter_expr: Optional[Expression] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filterExpr'), 'exclude': lambda f: f is None }})
