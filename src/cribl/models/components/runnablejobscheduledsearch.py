...
class RunnableJobScheduledSearchRunSettings:
    ...
    log_level: Optional[RunnableJobScheduledSearchLogLevel] = dataclasses.field(default=RunnableJobScheduledSearchLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
...
class RunnableJobScheduledSearchSchedule:
    ...
    run: Optional[RunnableJobScheduledSearchRunSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('run'), 'exclude': lambda f: f is None }})
