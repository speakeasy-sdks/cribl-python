...
class ExecutorSpecificSettings:
    pass
...
class RunnableJobExecutorExecutor:
    ...
    conf: Optional[ExecutorSpecificSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conf'), 'exclude': lambda f: f is None }})
...
class RunnableJobExecutorRun:
    ...
    log_level: Optional[RunnableJobExecutorLogLevel] = dataclasses.field(default=RunnableJobExecutorLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
...
class RunnableJobExecutorSchemasLogLevel(str, Enum):
    r"""Level at which to set task logging."""
    ERROR = 'error'
    WARN = 'warn'
    INFO = 'info'
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class RunnableJobExecutorRunSettings:
    ...
    log_level: Optional[RunnableJobExecutorSchemasLogLevel] = dataclasses.field(default=RunnableJobExecutorSchemasLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
    max_task_reschedule: Optional[int] = dataclasses.field(default=1, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxTaskReschedule'), 'exclude': lambda f: f is None }})
    r"""Max number of times a task can be rescheduled."""
...
class RunnableJobExecutorSchedule:
    ...
    run: Optional[RunnableJobExecutorRunSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('run'), 'exclude': lambda f: f is None }})
