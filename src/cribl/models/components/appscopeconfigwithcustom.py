...
import dataclasses
from .appscopecustom import AppscopeCustom
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppscopeConfigWithCustomFormat:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppscopeConfigWithCustomWatch:
...
class AppscopeConfigWithCustomEvent:
    ...
    format: AppscopeConfigWithCustomFormat = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format') }})
    transport: AppscopeTransport = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transport') }})
    type: AppscopeConfigWithCustomType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    watch: List[AppscopeConfigWithCustomWatch] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('watch') }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppscopeConfigWithCustomLog:
    level: Optional[AppscopeConfigWithCustomLevel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('level'), 'exclude': lambda f: f is None }})
    transport: Optional[AppscopeTransport] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transport'), 'exclude': lambda f: f is None }})
...
class AppscopeConfigWithCustomLibscope:
    ...
    log: Optional[AppscopeConfigWithCustomLog] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('log'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppscopeConfigWithCustomSchemasFormat:
...
class AppscopeConfigWithCustomMetric:
    enable: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('enable') }})
    format: AppscopeConfigWithCustomSchemasFormat = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format') }})
    transport: AppscopeTransport = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transport') }})
...
class AppscopeConfigWithCustom:
    ...
    custom: Optional[List[AppscopeCustom]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('custom'), 'exclude': lambda f: f is None }})
