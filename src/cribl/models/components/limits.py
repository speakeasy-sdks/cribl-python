...
class Limits:
    ...
    samples: Samples = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('samples') }})
    ...
    edge_metrics_mode: Optional[EdgeHeartbeatMetricsMode] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('edgeMetricsMode'), 'exclude': lambda f: f is None }})
