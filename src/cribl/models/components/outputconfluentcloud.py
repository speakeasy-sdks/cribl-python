...
class OutputConfluentCloudSchemasTLSSettingsClientSide:
    ...
    max_version: Optional[OutputConfluentCloudMaximumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxVersion'), 'exclude': lambda f: f is None }})
    r"""Maximum TLS version to use when connecting"""
    min_version: Optional[OutputConfluentCloudMinimumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('minVersion'), 'exclude': lambda f: f is None }})
    r"""Minimum TLS version to use when connecting"""
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class KafkaSchemaRegistryAuthentication:
    ...
    tls: Optional[OutputConfluentCloudSchemasTLSSettingsClientSide] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tls'), 'exclude': lambda f: f is None }})
...
class OutputConfluentCloudSchemasCompression(str, Enum):
...
class OutputConfluentCloudAuthentication:
    ...
    mechanism: Optional[OutputConfluentCloudSASLMechanism] = dataclasses.field(default=OutputConfluentCloudSASLMechanism.PLAIN, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mechanism'), 'exclude': lambda f: f is None }})
    r"""SASL authentication mechanism to use."""
...
class OutputConfluentCloudTLSSettingsClientSide:
    ...
    max_version: Optional[MaximumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxVersion'), 'exclude': lambda f: f is None }})
    r"""Maximum TLS version to use when connecting"""
    min_version: Optional[MinimumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('minVersion'), 'exclude': lambda f: f is None }})
    r"""Minimum TLS version to use when connecting"""
    passphrase: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('passphrase'), 'exclude': lambda f: f is None }})
    r"""Passphrase to use to decrypt private key."""
    priv_key_path: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('privKeyPath'), 'exclude': lambda f: f is None }})
...
class OutputConfluentCloud:
    ...
    kafka_schema_registry: Optional[KafkaSchemaRegistryAuthentication] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('kafkaSchemaRegistry'), 'exclude': lambda f: f is None }})
    ...
    pq_compress: Optional[OutputConfluentCloudSchemasCompression] = dataclasses.field(default=OutputConfluentCloudSchemasCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
