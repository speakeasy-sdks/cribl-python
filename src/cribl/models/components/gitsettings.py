...
class GitSettings:
    ...
    git_ops: Optional[GitOpsType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('gitOps'), 'exclude': lambda f: f is None }})
