...
class SavedJobScheduledSearchLogLevel(str, Enum):
...
class SavedJobScheduledSearchRunSettings:
    ...
    log_level: Optional[SavedJobScheduledSearchLogLevel] = dataclasses.field(default=SavedJobScheduledSearchLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
...
class SavedJobScheduledSearchSchedule:
    ...
    run: Optional[SavedJobScheduledSearchRunSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('run'), 'exclude': lambda f: f is None }})
