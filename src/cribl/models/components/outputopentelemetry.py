...
class OutputOpenTelemetrySchemasCompression(str, Enum):
    r"""Type of compression to apply to messages sent to the OpenTelemetry endpoint"""
    NONE = 'none'
    GZIP = 'gzip'
...
class OutputOpenTelemetryMetadata:
    ...
    key: Optional[str] = dataclasses.field(default='', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('key'), 'exclude': lambda f: f is None }})
...
class OutputOpenTelemetrySchemasPqCompressCompression(str, Enum):
...
class OutputOpenTelemetryTLSSettingsClientSide:
    ...
    max_version: Optional[OutputOpenTelemetryMaximumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxVersion'), 'exclude': lambda f: f is None }})
    r"""Maximum TLS version to use when connecting"""
    min_version: Optional[OutputOpenTelemetryMinimumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('minVersion'), 'exclude': lambda f: f is None }})
    r"""Minimum TLS version to use when connecting"""
...
class OutputOpenTelemetry:
    ...
    auth_type: Optional[OutputOpenTelemetryAuthenticationType] = dataclasses.field(default=OutputOpenTelemetryAuthenticationType.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""OpenTelemetry authentication type"""
    compress: Optional[OutputOpenTelemetryCompression] = dataclasses.field(default=OutputOpenTelemetryCompression.GZIP, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('compress'), 'exclude': lambda f: f is None }})
    r"""Type of compression to apply to messages sent to the OpenTelemetry endpoint"""
    ...
    failed_request_logging_mode: Optional[OutputOpenTelemetryFailedRequestLoggingMode] = dataclasses.field(default=OutputOpenTelemetryFailedRequestLoggingMode.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedRequestLoggingMode'), 'exclude': lambda f: f is None }})
    r"""Determines which data should be logged when a request fails. Defaults to None.  All headers are redacted by default, except those listed under `Safe Headers`."""
    ...
    http_compress: Optional[OutputOpenTelemetrySchemasCompression] = dataclasses.field(default=OutputOpenTelemetrySchemasCompression.GZIP, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('httpCompress'), 'exclude': lambda f: f is None }})
    r"""Type of compression to apply to messages sent to the OpenTelemetry endpoint"""
    ...
    keep_alive_time: Optional[int] = dataclasses.field(default=30, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('keepAliveTime'), 'exclude': lambda f: f is None }})
    ...
    on_backpressure: Optional[OutputOpenTelemetryBackpressureBehavior] = dataclasses.field(default=OutputOpenTelemetryBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputOpenTelemetrySchemasPqCompressCompression] = dataclasses.field(default=OutputOpenTelemetrySchemasPqCompressCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputOpenTelemetryQueueFullBehavior] = dataclasses.field(default=OutputOpenTelemetryQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    protocol: Optional[OutputOpenTelemetryProtocol] = dataclasses.field(default=OutputOpenTelemetryProtocol.GRPC, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    r"""Select a transport option for OpenTelemetry"""
    reject_unauthorized: Optional[bool] = dataclasses.field(default=False, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rejectUnauthorized'), 'exclude': lambda f: f is None }})
    r"""Reject certs that are not authorized by a CA in the CA certificate path, or by another trusted CA (e.g., the system's CA). Defaults to No."""
