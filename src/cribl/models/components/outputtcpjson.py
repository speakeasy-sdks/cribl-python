...
class OutputTcpjsonHosts:
    ...
    tls: Optional[OutputTcpjsonTLS] = dataclasses.field(default=OutputTcpjsonTLS.INHERIT, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tls'), 'exclude': lambda f: f is None }})
    r"""Whether to inherit TLS configs from group setting or disable TLS."""
...
class OutputTcpjsonSchemasCompression(str, Enum):
...
class OutputTcpjsonTLSSettingsClientSide:
    ...
    max_version: Optional[OutputTcpjsonMaximumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxVersion'), 'exclude': lambda f: f is None }})
    r"""Maximum TLS version to use when connecting"""
    min_version: Optional[OutputTcpjsonMinimumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('minVersion'), 'exclude': lambda f: f is None }})
    r"""Minimum TLS version to use when connecting"""
...
class OutputTcpjson:
    ...
    r"""The port to connect to on the provided host"""
    pq_compress: Optional[OutputTcpjsonSchemasCompression] = dataclasses.field(default=OutputTcpjsonSchemasCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
