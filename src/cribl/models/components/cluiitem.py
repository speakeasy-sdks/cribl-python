...
import dataclasses
from .cluicategory import CluiCategory
...
class CluiItem:
    category: CluiCategory = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category') }})
    type: CluiType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
