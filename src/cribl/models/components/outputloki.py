...
class OutputLoki:
    ...
    labels: Optional[List[Labels]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('labels'), 'exclude': lambda f: f is None }})
    ...
    message_format: Optional[MessageFormat] = dataclasses.field(default=MessageFormat.PROTOBUF, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('messageFormat'), 'exclude': lambda f: f is None }})
    r"""Which format to use when sending logs to Loki (Protobuf or JSON).  Defaults to Protobuf."""
