...
class OutputSplunkLbHosts:
    ...
    tls: Optional[OutputSplunkLbTLS] = dataclasses.field(default=OutputSplunkLbTLS.INHERIT, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tls'), 'exclude': lambda f: f is None }})
    r"""Whether to inherit TLS configs from group setting or disable TLS."""
...
class OutputSplunkLbSchemasAuthenticationMethod(str, Enum):
    r"""Enter a token directly, or provide a secret referencing a token"""
    SECRET = 'secret'
    MANUAL = 'manual'
...
class IndexerDiscoveryConfigs:
    ...
    auth_type: Optional[OutputSplunkLbSchemasAuthenticationMethod] = dataclasses.field(default=OutputSplunkLbSchemasAuthenticationMethod.MANUAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""Enter a token directly, or provide a secret referencing a token"""
...
class OutputSplunkLbTLSSettingsClientSide:
    ...
    max_version: Optional[OutputSplunkLbMaximumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxVersion'), 'exclude': lambda f: f is None }})
    r"""Maximum TLS version to use when connecting"""
    min_version: Optional[OutputSplunkLbMinimumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('minVersion'), 'exclude': lambda f: f is None }})
    r"""Minimum TLS version to use when connecting"""
...
class OutputSplunkLb:
    ...
    indexer_discovery_configs: Optional[IndexerDiscoveryConfigs] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('indexerDiscoveryConfigs'), 'exclude': lambda f: f is None }})
    r"""List of configurations to set up indexer discovery in Splunk Indexer clustering environment."""
