...
class SavedJobCollectionCollectorSpecificSettings:
    pass
...
class SavedJobCollectionCollector:
    conf: SavedJobCollectionCollectorSpecificSettings = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conf') }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SavedJobCollectionMetadata:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SavedJobCollectionPreprocess:
...
class SavedJobCollectionInput:
    ...
    metadata: Optional[List[SavedJobCollectionMetadata]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metadata'), 'exclude': lambda f: f is None }})
    ...
    preprocess: Optional[SavedJobCollectionPreprocess] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('preprocess'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[SavedJobCollectionType] = dataclasses.field(default=SavedJobCollectionType.COLLECTION, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SavedJobCollectionRunSettings:
    ...
    log_level: Optional[SavedJobCollectionLogLevel] = dataclasses.field(default=SavedJobCollectionLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
...
class SavedJobCollectionSchedule:
    ...
    run: Optional[SavedJobCollectionRunSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('run'), 'exclude': lambda f: f is None }})
