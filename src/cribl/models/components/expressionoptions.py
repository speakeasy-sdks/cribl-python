...
import dataclasses
from .partialevalrewrite import PartialEvalRewrite
from .traversecallback import TraverseCallback
...
class ExpressionOptions:
    ...
    ast_traverse_callback: Optional[TraverseCallback] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('astTraverseCallback'), 'exclude': lambda f: f is None }})
    ...
    partial_eval: Optional[PartialEvalRewrite] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('partialEval'), 'exclude': lambda f: f is None }})
