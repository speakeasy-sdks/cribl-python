...
class SchemasNotificationTargetPagerDutyOutputType(str, Enum):
    DEFAULT = 'default'
    WEBHOOK = 'webhook'
...
class NotificationTargetPagerDutySchemas:
    ...
    type: SchemasNotificationTargetPagerDutyOutputType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
...
class SchemasNotificationTargetNotificationsLogOutputType(str, Enum):
    DEFAULT = 'default'
    WEBHOOK = 'webhook'
    BULLETIN_MESSAGE = 'bulletin_message'
    ROUTER = 'router'
...
class NotificationTargetNotificationsLogSchemas:
    id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id') }})
    r"""Unique ID for this output"""
    type: SchemasNotificationTargetNotificationsLogOutputType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
...
class SchemasNotificationTargetRouterOutputType(str, Enum):
    DEFAULT = 'default'
    WEBHOOK = 'webhook'
    BULLETIN_MESSAGE = 'bulletin_message'
    ROUTER = 'router'
...
class NotificationTargetRouterSchemas:
    ...
    type: SchemasNotificationTargetRouterOutputType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    system_fields: Optional[List[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('systemFields'), 'exclude': lambda f: f is None }})
    r"""Set of fields to automatically add to events using this output. E.g.: cribl_pipe, c*. Wildcards supported."""
...
class SchemasOutputType(str, Enum):
    DEFAULT = 'default'
    WEBHOOK = 'webhook'
    BULLETIN_MESSAGE = 'bulletin_message'
    ROUTER = 'router'
...
class NotificationTargetBulletinMessageSchemas:
    id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id') }})
    r"""Unique ID for this output"""
    type: SchemasOutputType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
...
class SchemasNotificationTargetWebhookOutputType(str, Enum):
    DEFAULT = 'default'
    WEBHOOK = 'webhook'
    BULLETIN_MESSAGE = 'bulletin_message'
    ROUTER = 'router'
...
class NotificationTargetWebhookSchemas:
    id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id') }})
    r"""Unique ID for this output"""
    type: SchemasNotificationTargetWebhookOutputType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
...
class SchemasNotificationTargetDefaultOutputType(str, Enum):
    DEFAULT = 'default'
    WEBHOOK = 'webhook'
    BULLETIN_MESSAGE = 'bulletin_message'
    ROUTER = 'router'
...
class NotificationTargetDefaultSchemas:
    ...
    id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id') }})
    r"""Unique ID for this output"""
    type: SchemasNotificationTargetDefaultOutputType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    system_fields: Optional[List[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('systemFields'), 'exclude': lambda f: f is None }})
    r"""Set of fields to automatically add to events using this output. E.g.: cribl_pipe, c*. Wildcards supported."""
