...
class OutputSqs:
    ...
    queue_type: Optional[QueueType] = dataclasses.field(default=QueueType.STANDARD, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('queueType'), 'exclude': lambda f: f is None }})
    r"""The queue type used (or created). Defaults to Standard."""
