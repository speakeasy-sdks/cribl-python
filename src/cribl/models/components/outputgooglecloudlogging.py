...
class OutputGoogleCloudLogging:
    ...
    log_location_type: LogLocationType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLocationType') }})
    ...
    log_labels: Optional[List[LogLabels]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLabels'), 'exclude': lambda f: f is None }})
    ...
    payload_format: Optional[PayloadFormat] = dataclasses.field(default=PayloadFormat.TEXT, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payloadFormat'), 'exclude': lambda f: f is None }})
    r"""Format to use when sending payload. Defaults to Text."""
    ...
    resource_type_labels: Optional[List[ResourceTypeLabels]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resourceTypeLabels'), 'exclude': lambda f: f is None }})
