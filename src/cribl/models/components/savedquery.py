...
import dataclasses
from .savedqueryschedule import SavedQuerySchedule
...
class SavedQuery:
    ...
    schedule: Optional[SavedQuerySchedule] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('schedule'), 'exclude': lambda f: f is None }})
