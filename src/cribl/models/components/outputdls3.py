...
class OutputDlS3Compress(str, Enum):
...
class OutputDlS3Region(str, Enum):
...
class OutputDlS3:
    ...
    object_acl: Optional[ObjectACL] = dataclasses.field(default=ObjectACL.PRIVATE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('objectACL'), 'exclude': lambda f: f is None }})
    r"""Object ACL to assign to uploaded objects."""
    ...
    server_side_encryption: Optional[ServerSideEncryption] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('serverSideEncryption'), 'exclude': lambda f: f is None }})
    r"""Server-side encryption for uploaded objects."""
    ...
    storage_class: Optional[StorageClass] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('storageClass'), 'exclude': lambda f: f is None }})
    r"""Storage class to select for uploaded objects."""
    ...
    type: Optional[OutputDlS3Type] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
