...
class OutputInfluxdb:
    ...
    oauth_headers: Optional[List[OauthHeaders]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('oauthHeaders'), 'exclude': lambda f: f is None }})
    r"""Additional headers to send in the OAuth login request. @{product} will automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""
    oauth_params: Optional[List[OauthParams]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('oauthParams'), 'exclude': lambda f: f is None }})
    ...
    timestamp_precision: Optional[TimestampPrecision] = dataclasses.field(default=TimestampPrecision.MS, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('timestampPrecision'), 'exclude': lambda f: f is None }})
    r"""Sets the precision for the supplied Unix time values. Defaults to milliseconds."""
