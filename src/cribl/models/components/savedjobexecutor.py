...
class SavedJobExecutorExecutorSpecificSettings:
    pass
...
class SavedJobExecutorExecutor:
    ...
    conf: Optional[SavedJobExecutorExecutorSpecificSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conf'), 'exclude': lambda f: f is None }})
...
class SavedJobExecutorLogLevel(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class SavedJobExecutorRunSettings:
    ...
    log_level: Optional[SavedJobExecutorLogLevel] = dataclasses.field(default=SavedJobExecutorLogLevel.INFO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logLevel'), 'exclude': lambda f: f is None }})
    r"""Level at which to set task logging."""
...
class SavedJobExecutorSchedule:
    ...
    run: Optional[SavedJobExecutorRunSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('run'), 'exclude': lambda f: f is None }})
