...
class OutputCloudwatch:
    ...
    signature_version: Optional[SignatureVersion] = dataclasses.field(default=SignatureVersion.V4, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('signatureVersion'), 'exclude': lambda f: f is None }})
    r"""Signature version to use for signing CloudWatchLogs requests."""
