...
class OutputDatadog:
    ...
    content_type: Optional[SendLogsAs] = dataclasses.field(default=SendLogsAs.JSON, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contentType'), 'exclude': lambda f: f is None }})
    r"""The content type to use when sending logs."""
    ...
    r"""Default value for message severity. When you send logs as JSON objects, the event's '__severity' field (if set) will override this value."""
    site: Optional[DatadogSite] = dataclasses.field(default=DatadogSite.US, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('site'), 'exclude': lambda f: f is None }})
    r"""Datadog site to which events should be sent"""
