...
class Auth:
    auth_type: Optional[OutputElasticAuthenticationMethod] = dataclasses.field(default=OutputElasticAuthenticationMethod.MANUAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""Enter credentials directly, or select a stored secret"""
...
class OutputElastic:
    ...
    auth: Optional[Auth] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth'), 'exclude': lambda f: f is None }})
    ...
    elastic_version: Optional[ElasticVersion] = dataclasses.field(default=ElasticVersion.AUTO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('elasticVersion'), 'exclude': lambda f: f is None }})
    r"""Optional Elasticsearch version, used to format events. If not specified, will auto-discover version."""
    ...
    extra_params: Optional[List[ExtraParams]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('extraParams'), 'exclude': lambda f: f is None }})
    r"""Extra Parameters."""
    failed_request_logging_mode: Optional[OutputElasticFailedRequestLoggingMode] = dataclasses.field(default=OutputElasticFailedRequestLoggingMode.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('failedRequestLoggingMode'), 'exclude': lambda f: f is None }})
    r"""Determines which data should be logged when a request fails. Defaults to None.  All headers are redacted by default, except those listed under `Safe Headers`."""
    ...
    include_doc_id: Optional[bool] = dataclasses.field(default=True, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('includeDocId'), 'exclude': lambda f: f is None }})
    ...
    on_backpressure: Optional[OutputElasticBackpressureBehavior] = dataclasses.field(default=OutputElasticBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputElasticCompression] = dataclasses.field(default=OutputElasticCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputElasticQueueFullBehavior] = dataclasses.field(default=OutputElasticQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
