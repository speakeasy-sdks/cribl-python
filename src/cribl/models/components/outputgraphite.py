...
class OutputGraphite:
    ...
    protocol: Optional[DestinationProtocol] = dataclasses.field(default=DestinationProtocol.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    r"""Protocol to use when communicating with the destination."""
