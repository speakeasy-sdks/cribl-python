...
class OutputGoogleChronicle:
    log_type: DefaultLogType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logType') }})
    r"""Default log type value to send to Chronicle. Can be overwritten by event field __logType."""
    ...
    extra_log_types: Optional[List[ExtraLogTypes]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('extraLogTypes'), 'exclude': lambda f: f is None }})
    ...
    log_format_type: Optional[SendEventsAs] = dataclasses.field(default=SendEventsAs.UNSTRUCTURED, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logFormatType'), 'exclude': lambda f: f is None }})
