...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class EventBreakerRulesetTimestampFormat:
    ...
    type: Optional[TimestampType] = dataclasses.field(default=TimestampType.AUTO, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
...
class EventBreakerRulesetRules:
    ...
    timestamp: EventBreakerRulesetTimestampFormat = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('timestamp') }})
    r"""Auto, manual format (strptime) or current time."""
    ...
    definitions: Optional[Definitions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('definitions'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[EventBreakerType] = dataclasses.field(default=EventBreakerType.REGEX, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Event Breaker Type"""
...
class EventBreakerRuleset:
    ...
    lib: Optional[Library] = dataclasses.field(default=Library.CUSTOM, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lib'), 'exclude': lambda f: f is None }})
