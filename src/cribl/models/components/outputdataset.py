...
class OutputDataset:
    ...
    site: Optional[DataSetSite] = dataclasses.field(default=DataSetSite.US, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('site'), 'exclude': lambda f: f is None }})
    r"""DataSet site to which events should be sent"""
