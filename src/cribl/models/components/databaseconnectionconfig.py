...
class DatabaseConnectionConfig:
    ...
    database_type: Optional[DatabaseConnectionType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('databaseType'), 'exclude': lambda f: f is None }})
