...
class Acknowledgments(int, Enum):
    r"""Control the number of required acknowledgments"""
    ONE = 1
    ZERO = 0
    MINUS_1 = -1

class RecordDataFormat(str, Enum):
...
class Authentication:
    ...
    mechanism: Optional[SASLMechanism] = dataclasses.field(default=SASLMechanism.PLAIN, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mechanism'), 'exclude': lambda f: f is None }})
    r"""SASL authentication mechanism to use"""
...
class OutputAzureEventhub:
    ...
    ack: Optional[Acknowledgments] = dataclasses.field(default=Acknowledgments.ONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ack'), 'exclude': lambda f: f is None }})
    r"""Control the number of required acknowledgments"""
    ...
    format: Optional[RecordDataFormat] = dataclasses.field(default=RecordDataFormat.JSON, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format'), 'exclude': lambda f: f is None }})
    r"""Format to use to serialize events before writing to the Event Hubs Kafka brokers."""
    ...
    on_backpressure: Optional[OutputAzureEventhubBackpressureBehavior] = dataclasses.field(default=OutputAzureEventhubBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[Compression] = dataclasses.field(default=Compression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    pq_controls: Optional[PqControls] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqControls'), 'exclude': lambda f: f is None }})
    ...
    pq_on_backpressure: Optional[QueueFullBehavior] = dataclasses.field(default=QueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    sasl: Optional[Authentication] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sasl'), 'exclude': lambda f: f is None }})
    r"""Authentication parameters to use when connecting to brokers. Using TLS is highly recommended."""
    ...
    tls: Optional[TLSSettingsClientSide] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tls'), 'exclude': lambda f: f is None }})
