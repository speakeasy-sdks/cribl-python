...
class KeyMetadataEntity:
    ...
    algorithm: Optional[EncryptionAlgorithm] = dataclasses.field(default=EncryptionAlgorithm.AES_256_CBC, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('algorithm'), 'exclude': lambda f: f is None }})
    ...
    kms: Optional[KMSForThisKey] = dataclasses.field(default=KMSForThisKey.LOCAL, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('kms'), 'exclude': lambda f: f is None }})
