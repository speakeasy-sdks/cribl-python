...
@dataclasses.dataclass
class AxisLabel:
    formatter: Optional[Formatter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('formatter'), 'exclude': lambda f: f is None }})
