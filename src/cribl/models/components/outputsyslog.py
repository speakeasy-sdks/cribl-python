...
class OutputSyslogTLSSettingsClientSide:
    ...
    max_version: Optional[OutputSyslogMaximumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxVersion'), 'exclude': lambda f: f is None }})
    r"""Maximum TLS version to use when connecting"""
    min_version: Optional[OutputSyslogMinimumTLSVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('minVersion'), 'exclude': lambda f: f is None }})
    r"""Minimum TLS version to use when connecting"""
...
class OutputSyslog:
    ...
    app_name: Optional[str] = dataclasses.field(default='Cribl', metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('appName'), 'exclude': lambda f: f is None }})
    ...
    facility: Optional[Facility] = dataclasses.field(default=Facility.ONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('facility'), 'exclude': lambda f: f is None }})
    r"""Default value for message facility, will be overwritten by value of __facility if set. Defaults to user."""
    ...
    max_record_size: Optional[int] = dataclasses.field(default=1500, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('maxRecordSize'), 'exclude': lambda f: f is None }})
    ...
    message_format: Optional[OutputSyslogMessageFormat] = dataclasses.field(default=OutputSyslogMessageFormat.RFC3164, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('messageFormat'), 'exclude': lambda f: f is None }})
    r"""The syslog message format depending on the receiver's support"""
    ...
    on_backpressure: Optional[OutputSyslogBackpressureBehavior] = dataclasses.field(default=OutputSyslogBackpressureBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('onBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block, drop, or queue events when all receivers are exerting backpressure."""
    ...
    pq_compress: Optional[OutputSyslogCompression] = dataclasses.field(default=OutputSyslogCompression.NONE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqCompress'), 'exclude': lambda f: f is None }})
    r"""Codec to use to compress the persisted data."""
    ...
    pq_on_backpressure: Optional[OutputSyslogQueueFullBehavior] = dataclasses.field(default=OutputSyslogQueueFullBehavior.BLOCK, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pqOnBackpressure'), 'exclude': lambda f: f is None }})
    r"""Whether to block or drop events when the queue is exerting backpressure (full capacity or low disk). 'Block' is the same behavior as non-PQ blocking. 'Drop new data' throws away incoming data, while leaving the contents of the PQ unchanged."""
    ...
    protocol: Optional[OutputSyslogProtocol] = dataclasses.field(default=OutputSyslogProtocol.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    r"""The network protocol to use for sending out syslog messages"""
    severity: Optional[OutputSyslogSeverity] = dataclasses.field(default=OutputSyslogSeverity.FIVE, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('severity'), 'exclude': lambda f: f is None }})
    r"""Default value for message severity, will be overwritten by value of __severity if set. Defaults to notice."""
    ...
    timestamp_format: Optional[TimestampFormat] = dataclasses.field(default=TimestampFormat.SYSLOG, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('timestampFormat'), 'exclude': lambda f: f is None }})
    r"""Timestamp format to use when serializing event's time field"""
