...
import dataclasses
from .upgradepackageurls import UpgradePackageUrls
...
class UpgradeSettings:
    ...
    package_urls: Optional[List[UpgradePackageUrls]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('packageUrls'), 'exclude': lambda f: f is None }})
