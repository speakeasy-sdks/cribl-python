...
import dataclasses
from .eventbreakerrulefields import EventBreakerRuleFields
from cribl import utils
from dataclasses_json import Undefined, dataclass_json
from enum import Enum
from typing import Any, List, Optional

class EventBreakerRuleSchemasType(str, Enum):
    AUTO = 'auto'
    FORMAT = 'format'
    CURRENT = 'current'
...
class Timestamp:
    type: EventBreakerRuleSchemasType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
...
class EventBreakerRule:
    ...
    timestamp: Timestamp = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('timestamp') }})
    ...
    fields: Optional[List[EventBreakerRuleFields]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fields'), 'exclude': lambda f: f is None }})
