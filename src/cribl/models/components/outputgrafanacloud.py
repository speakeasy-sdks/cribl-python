...
class OutputGrafanaCloudSchemasTrue2AuthenticationType(str, Enum):
    r"""The authentication method to use for the HTTP requests"""
    CREDENTIALS_SECRET = 'credentialsSecret'
    TOKEN = 'token'
    TEXT_SECRET = 'textSecret'
...
class OutputGrafanaCloudPrometheusAuth:
    auth_type: Optional[OutputGrafanaCloudSchemasTrue2AuthenticationType] = dataclasses.field(default=OutputGrafanaCloudSchemasTrue2AuthenticationType.BASIC, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authType'), 'exclude': lambda f: f is None }})
    r"""The authentication method to use for the HTTP requests"""
    credentials_secret: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentialsSecret'), 'exclude': lambda f: f is None }})
    r"""Select (or create) a secret that references your credentials"""
    password: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('password'), 'exclude': lambda f: f is None }})
