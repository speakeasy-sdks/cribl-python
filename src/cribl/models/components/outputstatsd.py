...
class OutputStatsd:
    ...
    protocol: Optional[OutputStatsdDestinationProtocol] = dataclasses.field(default=OutputStatsdDestinationProtocol.undefined, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    r"""Protocol to use when communicating with the destination."""
