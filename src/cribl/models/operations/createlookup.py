...
class CreateLookupRequestBody2:
...
@dataclasses.dataclass
class CreateLookupRequestBody1FileInfo:
...
@dataclasses.dataclass
class CreateLookupRequestBody1:
    id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id') }})
    r"""Filename with the lookup table. Required."""
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description'), 'exclude': lambda f: f is None }})
    r"""Brief description of this lookup. Optional."""
    file_info: Optional[CreateLookupRequestBody1FileInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fileInfo'), 'exclude': lambda f: f is None }})
    r"""Uploaded file information"""
    size: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('size'), 'exclude': lambda f: f is None }})
    r"""File size. Optional."""
    tags: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tags'), 'exclude': lambda f: f is None }})
