...
class GroupBundle:
    ...
    def get(self, id: str, deploy_request: Optional[components.DeployRequest] = None) -> operations.GetGroupBundleResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getGroupBundle', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        url = utils.generate_url(base_url, '/master/groups/{id}/configVersion', request)
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.GetGroupBundleRequest, "deploy_request", False, True, 'json')
        ...
        res = operations.GetGroupBundleResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
