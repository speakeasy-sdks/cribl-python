...
class ListGlobalVariable:
    ...
    def get(self) -> operations.GetListGlobalVariableResponse:
        r"""Get a list of Global Variable objects
        Get a list of Global Variable objects
        """
        hook_ctx = HookContext(operation_id='getListGlobalVariable', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetListGlobalVariableResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
