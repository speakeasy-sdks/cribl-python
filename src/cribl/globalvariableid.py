...
class GlobalVariableID:
    ...
    def delete(self, id: str) -> operations.DeleteGlobalVariableIDResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='deleteGlobalVariableID', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        url = utils.generate_url(base_url, '/lib/vars/{id}', request)
        ...
        res = operations.DeleteGlobalVariableIDResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def get(self, id: str) -> operations.GetGlobalVariableIDResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getGlobalVariableID', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetGlobalVariableIDResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def update(self, id: str, global_var: Optional[components.GlobalVar] = None) -> operations.UpdateGlobalVariableIDResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='updateGlobalVariableID', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdateGlobalVariableIDRequest, "global_var", False, True, 'json')
        ...
        res = operations.UpdateGlobalVariableIDResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
