...
class CriblSystemSettings:
    ...
    def get(self) -> operations.GetCriblSystemSettingsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='getCriblSystemSettings', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetCriblSystemSettingsResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
    ...
    def update(self) -> operations.UpdateCriblSystemSettingsResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='updateCriblSystemSettings', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
        ...
        res = operations.UpdateCriblSystemSettingsResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
