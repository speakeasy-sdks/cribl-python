...
class ListSchema:
    ...
    def get(self) -> operations.GetListSchemaResponse:
        r"""Get a list of Schema objects
        Get a list of Schema objects
        """
        hook_ctx = HookContext(operation_id='getListSchema', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetListSchemaResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
