...
class SampleOutput:
    ...
    def post(self, id: str, output_test_request: Optional[shared.OutputTestRequest] = None) -> operations.PostSampleOutputResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.OutputTestResponses])
