...
class Role:
    ...
    def delete(self, request: operations.DeleteRoleRequest) -> operations.DeleteRoleResponse:
        r"""Delete Role
        Delete Role
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def get(self, request: operations.GetRoleRequest) -> operations.GetRoleResponse:
        r"""Get Role by ID
        Get Role by ID
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
    ...
    def update(self, request: operations.UpdateRoleRequest) -> operations.UpdateRoleResponse:
        r"""Update Role
        Update Role
        """
        base_url = utils.template_url(*self.sdk_configuration.get_server_details())
