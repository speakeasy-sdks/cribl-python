...
class NotificationTargets:
    ...
    def get(self) -> operations.GetNotificationTargetsResponse:
        r"""Get a list of NotificationTarget objects
        Get a list of NotificationTarget objects
        """
        hook_ctx = HookContext(operation_id='getNotificationTargets', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetNotificationTargetsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
