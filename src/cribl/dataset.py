...
class Dataset:
    ...
    def delete(self, request: operations.DeleteDatasetProviderTypeRequest) -> operations.DeleteDatasetProviderTypeResponse:
    ...
    def get(self, request: operations.GetDatasetProviderTypeRequest) -> operations.GetDatasetProviderTypeResponse:
    ...
    def update(self, request: operations.UpdateDatasetProviderTypeRequest) -> operations.UpdateDatasetProviderTypeResponse:
