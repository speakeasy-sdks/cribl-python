...
class RouteObject:
    ...
    def update(self, id: str, routes: Optional[components.RoutesInput] = None) -> operations.UpdateRouteObjectResponse:
        ...
        """
        hook_ctx = HookContext(operation_id='updateRouteObject', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        url = utils.generate_url(base_url, '/routes/{id}', request)
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.UpdateRouteObjectRequest, "routes", False, True, 'json')
        ...
        res = operations.UpdateRouteObjectResponse(http_meta=components.HTTPMetadata(request=req, response=http_res))
