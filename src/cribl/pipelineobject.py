...
class PipelineObject:
    ...
    def get(self) -> operations.GetPipelineObjectResponse:
        r"""Get a list of Pipeline objects
        Get a list of Pipeline objects
        """
        hook_ctx = HookContext(operation_id='getPipelineObject', oauth2_scopes=[], security_source=self.sdk_configuration.security)
        ...
        res = operations.GetPipelineObjectResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
